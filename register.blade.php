...
<form action="{{ route('register') }}" method="post">
    ...
    <div class="form-outline mb-4">
        ...
        <input type="email" name="email" id="form2Example11" class="form-control" placeholder="Ingresar dirección de correo electrónico" />
    </div>
    ...
    <div class="text-center pt-1 mb-5 pb-1">
        <button class="bn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">Ingresar</button>
    </div>
